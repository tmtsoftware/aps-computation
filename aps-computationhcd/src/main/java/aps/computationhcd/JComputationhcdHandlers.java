 ...
 */
public class JComputationhcdHandlers extends JComponentHandlers {

    private final JCswContext cswCtx;
    private final ILogger log;

    JComputationhcdHandlers(ActorContext<TopLevelActorMessage> ctx,JCswContext cswCtx) {
        super(ctx, cswCtx);
        this.cswCtx = cswCtx;
    ...
    log.info("Initializing computationHcd...");
    }
