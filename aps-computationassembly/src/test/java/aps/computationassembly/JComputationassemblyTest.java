...
public class JComputationassemblyTest extends JUnitSuite {
    ...
    public void testAssemblyShouldBeLocatableUsingLocationService() throws ExecutionException, InterruptedException {
        Connection.AkkaConnection connection = new Connection.AkkaConnection(new ComponentId(Prefix.apply("APS.computationAssembly"), JComponentType.Assembly));
